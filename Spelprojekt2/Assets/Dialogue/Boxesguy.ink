...
+ [> <i>Acknowledge</i>]
    ...Okay? I take it I <i>don't</i> want the box to disintegrate. # speaker=Alea #anim=isTalking:bool=false;
        You really hit the nail on the head with that one! # speaker=Boxesguy #anim=isTalking:bool=true;
        ...
        ++ [> <i>Acknowledge</i>]
            I see. # speaker=Alea #anim=isTalking:bool=false;
            Also, you see that ghostly outline of a cube? That's the box's spawner. # speaker=Boxesguy #camera=1 #anim=isTalking:bool=true;
