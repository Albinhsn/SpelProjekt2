...
I do not intend for whatever <i>bodily liquids</i> stored inside you to be splattered all over these containers.
...
Thank youuu <i>USER</i>! Now shoo, I need to get back to cleaning as soon as you pass through. # camera=0 # anim=Turn:bool=false;
->DONE
=polish2
<i>She seems to be whispering to herself as she cleans the container.</i> # camera=0
