...
No one, not a singular <i>thing</i> is allowed to use the catwalks anymore, period.
    * [But I need to use the catwalks.] I need to talk to the priest. # speaker=Alea
    Are you super duper sure? I <i>really</i> don't want to clean these catwalks again. # speaker=Catwalk Lady
    ** Sadly, yes. # speaker=Alea
        ... alright then. But please... no more after that. I can't take it anymore. # speaker=Catwalk Lady
        ->DONE 
